   ...
   <section id="" class=" container-fluid content-section text-center">
		...
		<p><br><br></p>
            <div class="col-lg-10 col-lg-offset-1">
                <h2>My account</h2>
                <a class="page-scroll" href="https://in.explara.com/e/pravega-registration-2015" target="_blank" style="font-size:25px;">Pay Online Now and get Rs 50 Off!</a><br />
                <a class="page-scroll" href="https://in.explara.com/e/pravega-accommodation-2015" target="_blank" style="font-size:25px;">Accommodation Payment</a>
                <?php
				$id = $_SESSION['user_id'];
				$event = 1;
				...
				?>
                	<span style="font-size:18px; display:block; margin-top:30px;">Single Events</span><br />
				...
				?>
                	<span style="font-size:18px; display:block; margin-top:30px;">Group Events</span><br />
                	<table class='table table-striped table-bordered' align="center" style="width:60%">
                      <tr class='odd'>
                        <th style="width:20px;text-align:center;">Event No.</th>
                        <th style="width:50px;text-align:center;">Event Name</th>
