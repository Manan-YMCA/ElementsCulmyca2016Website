<div class="headerpanel">
    ...
    <div class="headerright">
        ...
        <div class="dropdown userinfo">
            <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="/page.html">Hi, <?= $_SESSION['user'] ?>! <b class="caret"></b></a>
            <ul class="dropdown-menu">
            	<li><a href="pravega_action.php?password" class="pop_up"><span class="icon-edit"></span> Change Password</a>
