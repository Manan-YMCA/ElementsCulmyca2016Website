    ...
    <section id="enggrules" class=" about container-fluid content-section text-center">
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1">
                <h2>rules</h2>
                <p class="col-lg-10 col-lg-offset-1" style="text-align: justify">
1. This is an Online Programming Contest to be held on 17<sup>th</sup>&nbspJanuary 2015, 9 pm onwards.<br>
2. Participation can be in teams of at most 3.<br>
3. The contest will be hosted on CodeChef platform. (<a href="http://www.codechef.com/PRVG2015/" target="_blank" style="font-weight:bold">CodeChef event page</a>)<br>
