...
3. Based on the performance in the prelims, 6-8 (based on the Judge’s discretion) teams will proceed towards the final round, which will be in the format of a quiz with several rounds. This part will have conceptual theoretical questions, interspersed with fun questions here and there.<br>
