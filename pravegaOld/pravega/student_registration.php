    ...
    <section id="" class=" container-fluid content-section text-center">
        <div class="row">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <h2><br>Student Registration</h2>
                <p class="col-lg-10 col-lg-offset-1" style="text-align: justify; ">
				
1. To participate in any competition or event in Pravega, you must first register by filling in the student registration 
form online or, by registering on the spot when you come to Pravega’15. <br>
				
2. On the Spot Registrations, however, will not allow you to participate in the following : Idea Within, TrollStein, Online Programming Contest
and Battle of Bands.<br>
3. To participate in the Quizzes - Inquizitive and ScienceQuizine, you need not register online - Registrations and 
Payment for participation in these competitions will be done on the day of the quiz itself.<br>

4. Registration is not mandatory for attending Pro-nites.<br>

5. You can participate in all online competitions for free.<br><br>
<p class="col-lg-10 col-lg-offset-1" style="text-align:center">
<a href="#form" class="btn btn-circle page-scroll">
    <i class="fa fa-angle-double-down animated"></i>
</a></p></p>
</div></div></section></div>
</header>
        <div class="row">
<section id="form" class=" container-fluid content-section text-center">
		<div class="col-lg-8 col-lg-offset-2">
<p style="text-align:center"><br><br><a href="rdetails.php" style="border: 1px solid #219ab3 !important;" class="btn  btn-default btn-lg button">How to register online</a></p>
