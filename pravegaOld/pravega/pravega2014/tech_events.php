...
<html lang="en">
	...
	<head>
		<title>Technical Events | Pravega – the IISc Science, Tech and Cultural Fest</title>
		...
		<script src="js/subject_tiles.js"></script> 
	</head>
												...
												<!-- Content -->
													<div id="content">
														<article class="is is-post">
															...
															<div class="row">
															<br>
															<div id="all_subj_tiles">
																<div style="text-align:center" align="center"> 
																	<a href="physics">
																	<div class="subject_tiles" id="sub_tile1" style="background-image:url('images/Tiles/Physics.jpg')"></div></a> 
																	
																	<a href="chemistry">
																	<div class="subject_tiles" id="sub_tile2" style="background-image:url('images/Tiles/Chemistry.jpg')"></div></a>
																	
																	<a href="math">
																	<div class="subject_tiles" id="sub_tile3" style="background-image:url('images/Tiles/Math.jpg')"></div></a>
																</div>
																	
																	<div style="text-align:center; padding-top:32px;" align="center"> <a href="biology">
																<div class="subject_tiles" id="sub_tile4" style="background-image:url('images/Tiles/Bio.jpg')"></div></a> 
																	<a href="engineering">
																	<div class="subject_tiles" id="sub_tile5" style="background-image:url('images/Tiles/Engineering.jpg')"></div></a>
																
																	<a href="multi-disciplinary">
																	<div class="subject_tiles" id="sub_tile6" style="background-image:url('images/Tiles/multi-disciplinary.jpg')"></div></a>
																...
																<div class="5u hyphenate">
																	<p>Pravega 2013 will play host to a broad spectrum of exciting technical events ranging from coding competitions to kitchen chemistry to cryptography. With over 40 original competitions carefully crafted by Team Pravega and some of the best minds in the country as competitors, only the truly deserving will emerge unscathed from the test of fire. </p>
																</div>
																<div class="5u hyphenate">
																	<p>Come, immerse yourself wholeheartedly in the spirit of Science and Engineering.</p>
																	<p>For the pure joy of it. </p>
																	<p>Also because you can walk away with jingling pockets.</p>
																</div>
																<div class="12u" align="center">
																	<p><h3>What more could you want?</h3></p>
																</div>
																<section class="1u"></section>
															</div>
