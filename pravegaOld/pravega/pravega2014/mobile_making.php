			...
			<div id="header-wrapper" class="wrapper" style="background-size:cover;">
				...
				<div class="not-mobile" id="profile-bar">
					...
					<span style="float:left; width:45%; text-align:left;">
						<a href="exhibitions">Workshops</a> > <?php echo '<a href="'.$file_name.'">'.$name.'</a>'; ?> </span>					
											...
											<div class="3u" style="padding-left:65px;">
												...
												<!-- Sidebar -->
													<div id="sidebar">
														<section class="is">
															<header>
																<h2><a href="exhibitions">Workshops</a></h2>
															</header>
															
															<ul>
															<?php
																$subject_list=array("Workshops");
														...
														<article class="is is-post">
															...
															?>
																	<hr style="margin:1.5em 0em 1.5em 0em;">
																		<div style="text-align:center;"><h2>You have registered your team successfully.<br>However, your seat is not confirmed till payment is complete at <a href="http://em.explara.com/event/pravega-workshops" target="_blank">Explara.com</a>.</h2></div>
																	<hr style="margin:1.5em 0em 1.5em 0em;"><br>
															<?php
																}
																
																elseif (isset($_SESSION['error_capacity']))
																{
															?>	
																	<hr style="margin:1.5em 0em 1.5em 0em;">
																		<div style="text-align:center;"><h2>Sorry, but this event has had all its seats filled. Please email <a href="mailto:contact@pravega.org">contact@pravega.org</a> to be put on the waitlist.</h2></div>
																	<hr style="margin:1.5em 0em 1.5em 0em;"><br>
															<?php
																}
															?>																
															...
															<div class="row">
																<div class="2u"></div>
																<div class="8u hyphenate" style="padding-top:1px;">
																<?php
																	echo "<div style='text-align:center; padding-top:25px;'><img style='display:inline;' width=350 src='images/".$image."'></div>";
																...
																<div class="12u" align="center" style="margin-top:10px;">
																	...
																	<div>
																		...
																		<?php
																			...
																			else echo "<b>Sorry, this event has reached its capacity and is no longer accepting registrations. There will be no spot registrations.</b>";
