														...
														<article class="is is-post">
															...
															<div class="row">
																<div class="12u" style="text-align:center; border-top-style: 0px solid; padding-top: 0px; margin-top: 25px;" align="center">
																	<div style="width: 450px; margin:auto;cursor: pointer;" align="center">
																		...
																		<span id="rules_button" class="subject_nav_button" style="border-radius:0px 5px 5px 0px; margin-left: -6px; border-left: 1px solid black;">Rules</span>
																	</div>
																</div>
															</div>
															...
															<div class="row">
																<span id="register_content" style="display:none;">
																	<div align="center">
																		Registration will not be open in advance for this competition.
																	</div>
																</span>
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width:auto; left:50%; margin-left: -310px;" src="images/events/crossword.jpg" /><br><br>
																	<?php
