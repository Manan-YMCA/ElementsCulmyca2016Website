...
<html lang="en">
	...
	<head>
		<title>Guest Speakers | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<div class="5u hyphenate">
																	<p>Pravega will play host to tens of eminent personalities - all experts in their own fields and enchanting orators in their own right. Renowned scientists, industrialists, entrepreneurs, artists, and </p>
																</div>
																<div class="5u hyphenate">
																	<p>authors will all be flying in from across the world to inspire and entertain. We have a motley list of talks planned for you &ndash; all the way from nanotechnology to entrepreneurship.</p>
																</div>
																<div class="12u" align="center">
																	<p><h3>Keep checking for updates!</h3></p>
																</div>
																<section class="1u"></section>
															</div>
														</article>
