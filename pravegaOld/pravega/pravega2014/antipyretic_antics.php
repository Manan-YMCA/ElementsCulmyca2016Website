		...
		<!-- Header Wrapper -->
			...
			<div id="header-wrapper" class="wrapper" style="background-size:cover;">
				...
				<div class="not-mobile" id="profile-bar">
					<span id="countdown" style="position: absolute; left: 50%; margin-left:-61px; color: rgba(255,255,255,0.8)">
						<?php
							$date = date("j");
							if ($date < 19 && $date > 20)
								echo "Just " .(31-$date) ." days to go!";
							else
								echo "Pravega has begun!";
						?>
					</span>
														...
														<article class="is is-post">
															...
															<div class="row">
																<span id="register_content" style="display:none;">
																	<div align="center">
																		...
																		<form method="post" action="register_event.php" class="signin">
																			...
																			<tr>
																				<td class="form_labels">Email Address:<div style="font-size:13px; margin-top:-7px;">(As registered here)</div></td>
																				<td><input required autocomplete class="text <?php if (isset($_SESSION['errors_email3']) || isset($_SESSION['errors_activation3']) || isset($_SESSION['errors_in_team3']))echo "error";?>" type="email" name="email3" placeholder="Email Address<?php if ($_SESSION['errors_email3'] == 1) echo " not found, or duplicate."; else if ($_SESSION['errors_activation3'] == 1) echo " not activated."; else if (isset($_SESSION['errors_in_team3'])) echo " already registered.";?>" <?php if ((!isset($_SESSION['errors_email3'])) && (!isset($_SESSION['errors_activation3'])) && (!isset($_SESSION['errors_in_team3']))) echo 'value="'. $_SESSION['email3']. '"';?>></td>
																			</tr>
																			...
																			<tr>
																				<td class="form_labels">Email Address:<div style="font-size:14px; margin-top:-7px;">(As registered here)</div></td>
																				<td><input required autocomplete class="text <?php if (isset($_SESSION['errors_email4']) || isset($_SESSION['errors_activation4']) || isset($_SESSION['errors_in_team4']))echo "error";?>" type="email" name="email4" placeholder="Email Address<?php if ($_SESSION['errors_email4'] == 1) echo " not found, or duplicate."; else if ($_SESSION['errors_activation4'] == 1) echo " not activated."; else if (isset($_SESSION['errors_in_team4'])) echo " already registered.";?>" <?php if ((!isset($_SESSION['errors_email4'])) && (!isset($_SESSION['errors_activation4'])) && (!isset($_SESSION['errors_in_team4']))) echo 'value="'. $_SESSION['email4']. '"';?>></td>
																			</tr>
																			<tr>
																...
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width:550px; left:50%; margin-left: -275px;" src="images/events/antipyretic_antics.jpg" /><br><br>
																	<?php
