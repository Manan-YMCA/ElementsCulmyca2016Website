...
<html lang="en">
	...
	<head>
		<title><?php echo $subject; ?> Events | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
		...
		<!-- Header Wrapper -->
			...
			<div id="header-wrapper" class="wrapper" style="background-size:cover;">
				...
				<span style="float:left; width:45%; text-align:left;">
					<a href="tech_events">Technical Events</a> > <?php echo '<a href="'.strtolower($subject).'">'.$subject.'</a>'; ?></span>
