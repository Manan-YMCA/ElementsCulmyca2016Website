														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<span id="desc" style="display:none;">
																	<img onclick="load_image(this); return false;" style="position: relative; display: inline-block; width: 600px; left:50%; margin-left: -300px; cursor: pointer;" src="images/events/pixel_pundit.jpg" /><br><br>
																	<?php
