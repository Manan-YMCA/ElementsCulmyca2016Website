<?php
	...
	$name = "Cloud Computing & Google App Engine Workshop";
	$db_event_name = "Cloud Computing and Google App Engine Workshop";
													...
													<div id="content">
														<article class="is is-post">
															...
															<div class="row">
																...
																<?php
																	echo "<div style='text-align:center; padding-top:25px;'><img style='display:inline;' width=300 src='images/".$image."'></div>";
																...
																<div class="12u" align="center" style="margin-top:10px;">
																	...
																	<div>
																		...
																		<?php
																			...
																			else echo "<b>Sorry, this event has reached its capacity and is no longer accepting registrations. Spot registrations are open at Pravega:<br> Batch 1: 12pm 31st Jan - 1st Feb.<br>Batch 2: Feb 1st and Feb 2nd</b>";
																		?>
																	</div>
																</div>
															</div>
