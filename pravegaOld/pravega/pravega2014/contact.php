...
<html lang="en">
	...
	<head>
		<title>Contact Us | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
												...
												<!-- Content -->
													<div id="content">
														<article class="is is-post">
															...
															<div class="row">
																<div class="12u people_desc" style="font-style:normal; margin-bottom:0em;" align="center" style="text-align: center;">
																		<h3>For general queries: email us at <a href="mailto:contact@pravega.org">contact@pravega.org</a>.</h3>
																</div>
															</div>
															<div class="row" style="text-align: center;">
																<section class="2u"></section>
																<div class="3u hyphenate">
																	<img src="images/team/apaar.jpg" style="width: 200px; border-radius: 3px; border: 1px black solid;">
																	<h3>Apaar Shanker</h3>
																		Outreach Coordinator<br>
																		(Marketing and Sponsorship)
																		<div class="people_desc">
																		<a href="mailto:apaar@pravega.org">apaar@pravega.org</a>
																	</div>
																</div>
																<div class="3u hyphenate">
																	<img src="images/team/pranav.jpg" style="width: 200px; border-radius: 3px; border: 1px black solid;">
																	<h3>Pranav Mundada</h3>
																		Chief Coordinator<br><br>
																		<div class="people_desc">
																		<a href="mailto:pranav@pravega.org">pranav@pravega.org</a><br>
																		
																	</div>
																</div>
																<div class="3u hyphenate">
																	<img src="images/team/aditya.jpg" style="width: 200px; border-radius: 3px; border: 1px black solid;">
																	<h3>Aditya Hebbar</h3>
																		Core Committee<br>
																		(Events and Competitions)
																		<div class="people_desc">
																		<a href="mailto:aditya@pravega.org">aditya@pravega.org</a>
																	</div>
																</div>
															...
															<div class="row">
																...
																<h3>For mail correspondence, contact us at</h3>
																	UG Office,<br>
																	UG Complex,<br>
