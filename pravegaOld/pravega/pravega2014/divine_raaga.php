...
<html lang="en">
	...
	<head>
		<title>Divine Raaga - Pronights | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
												...
												<!-- Content -->
													<div id="content">
														<article class="is is-post">
															...
															<div class="row">
																<div class="12u">
																	<img onclick="load_image(this);" style="position: relative; display: inline-block; width:600px; margin-left: -300px; left: 50%; cursor: pointer; " src="images/events/divine_raaga.jpg" />
																	<br>
																</div>
															</div>
															<div class="row">
																...
																<div class="8u hyphenate">
																	<p>On the second night, Pravega presents a scintillating performance by Divine Raaga!</p>
																	<p>Divine Raaga is a Hindi rock band based out of Bangalore, India. They are one of the most loved bands in the city. Their compositions draw influences from multiple genres rooted in Indian music, amalgamated with rock. Their music is known for its soulful rendition, heavenly connect and lyrical depth. Their two-word name, with one word from Sanskrit and the other from English, perfectly portrays the sense of fusion in their music, while their 'ambigram' logo showcases the concept of symmetry in nature!</p>
																	<p>Entry is free of charge, as Divine Raaga is playing as part of the "Pay For The Arts" initiative.</p>
