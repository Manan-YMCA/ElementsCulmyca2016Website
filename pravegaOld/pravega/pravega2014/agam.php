...
<html lang="en">
	...
	<head>
		<title>Agam - Pronights | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
												...
												<!-- Content -->
													<div id="content">
														<article class="is is-post">
															...
															<div class="row">
																<div class="12u">
																	<img onclick="load_image(this);" style="position: relative; display: inline-block; width:550px; margin-left: -275px; left: 50%; cursor: pointer; " src="images/events/agam.jpg" />
																	<br><br>
																	<p style="text-align:center;">
																		<a href="" class="button button-style1" onclick="$.scrollTo('#book', 400, {offset:-25}, {easing:'swing'}); return false;">Book now!</a>
																	</p>
																</div>
															</div>
															<div class="row">
																...
																<div class="8u hyphenate" style="margin-top: -25px;">
																	<p>Agam will be performing at Pravega on 2nd February for the final pronight!</p>
																	...
																	<p>Complimentary tickets will be provided for all participants of Pravega, as well as all who purchase Pravega merchandise during the fest. Tickets will be available on site for Rs. 50 for others who wish to attend. Tickets can also be purchased online below.
																	<hr>
