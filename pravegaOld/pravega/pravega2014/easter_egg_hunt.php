																...
																<span id="register_content" style="display:none;">
																	...
																	<h2 id="register">Register</h2>
																		<?php
																			...
																			else echo "The competition is over. Winners will be announced shortly.";
																		?>
																	</div>
																</span>
																<span id="desc" style="display:none;">
																	<img onclick="load_image(this); return false;"  style="cursor: pointer; position: relative; display: inline-block; width: 600px; left:50%; margin-left: -300px;" src="images/events/easter_egg_hunt.jpg" /><br><br>
																	<?php
