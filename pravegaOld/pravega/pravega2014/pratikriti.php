<?php
	...
	$name = "Carl Zeiss Pratik&#7771;ti";
	$db_event_name = "Carl Zeiss Pratikriti";
														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width:600px; left:50%; margin-left: -300px; cursor: pointer;" src="images/events/pratikriti.jpg" onclick="load_image(this);"/><br><br>
																	<?php
