...
<html lang="en">
	...
	<body class="left-sidebar" onkeydown="shiftDown(event);" onkeyup="shiftUp(event);" onload="<?php if($_SESSION['login'] == 1) echo "location.hash = 'register';";?> load_content();">
		<div id="mask"></div>
			...
			<div id="header-wrapper" class="wrapper" style="background-size:cover;">
				...
				<div class="not-mobile" id="profile-bar">
					...
					<span style="float:left; width:45%; text-align:left;">
						<a href="cultural">Cultural Events</a> > <?php echo '<a href="'.$file_name.'">'.$name.'</a>'; ?> </span>
														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<span id="desc" style="display:none;">
																	<img src="images/<?php echo $image; ?>" onclick="load_image(this); return false;" style="position: relative; display: inline-block; width: 600px; margin-left: -300px; left: 50%; cursor:pointer;"><br>
																	<br>
																	<?php
																...
																<span id="actual_desc" style="display:none;">
																	<img src="images/<?php echo $image; ?>" onclick="load_image(this); return false;" style="position: relative; display: inline-block; width: 600px; margin-left: -300px; left: 50%; cursor:pointer;"><br>
																	<br>
																	<?php
																		for ($i=0; $i < sizeof($desc); $i++)
																...
																<span id="pirate_desc" style="display:none;">
																	<img src="images/<?php echo $image; ?>" onclick="load_image(this); return false;" style="position: relative; display: inline-block; width: 600px; margin-left: -300px; left: 50%; cursor:pointer;"><br>
																	<br>
																	<p>
																		Pravega invites all ye buddin' wordsmiths to craft essays on any 'o our six topics.
																	</p>
																	<p>
																	</p>
																	<center>
																		<b><a href="rulebook/Wordsmithy.pdf">Essay topics be out. Click here t' loot!</a></b>
																	</center>
																	<p></p>
																	<p>
																		Wordsmithy be all about puttin' across ideas in a persuasive 'n coherent way; we do nah really care about how well ye dodge split infinitives or if <a target="_blank" href="http://en.wiktionary.org/wiki/sesquipedalian#Noun">sesquipedalian</a> blood runs in yer veins. Feel free t' use any kind o' persuasion in yer essay: images, cartoons, sketches or even links t' audio/video! But don't forget t' keep <a href="http://en.wikipedia.org/wiki/Chekhov's_gun" target="_blank">Cap'n Chekhov</a> in aft o' yer mind!
																	</p>
																	<p> </p>
																	<p> </p><center><b>What's at stake?</b><br> 1st Prize: Rs. 3000<br> 2nd Prize: Rs. 2000<br> 3rd Prize: Rs. 1000<br>Th' top 10 essays be gettin' certificates fro' IISc Pravega 2014.</center><p></p>
																	<p><i>Though IISc be a science institute, we be NOT specifically lookin' fer arguments t' support/deify science in any way. We be lookin' fer wha' YOU reckon! 'n that's wha' ye should put t' paper, even if it involves makin' a mickey out o' science.</i></p>
																	<p>
																	</p>
																	<center>
																		<b> Co-ordinator: </b> <br> Suhas M<br> <a href="mailto:suhas@pravega.org" target="_blank">suhas@pravega.org</a><br>
																	</center>
																	<p></p>																																
																	<p style="text-align:center;">
																		<a href="" class="button button-style1" id="big_register_button" onclick="big_reg_button(); return false;">Register now!</a>
																...
																<script>
																	var actual_desc = document.getElementById("actual_desc");
																	var pirate_desc = document.getElementById("pirate_desc");
																	var shiftdown = 0;
																	
																	function shiftDown(e){
																		if ((e.keyCode === 16 || e.charCode === 16) && shiftdown == 0)
																		{
																			shiftdown = 1;
																			console.log("hi");
																			document.getElementById("desc").innerHTML = pirate_desc.innerHTML;
																	...
																	function shiftUp(e){
																		if ((e.keyCode === 16 || e.charCode === 16) && shiftdown == 1)
																		{
																			shiftdown = 0;
																			document.getElementById("desc").innerHTML = actual_desc.innerHTML;
																			current = "a";
																			load_content();
																		}
																	}
