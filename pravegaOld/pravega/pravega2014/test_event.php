															...
															<div class="row">
																<span id="register_content" style="display:none;">
																	<div align="center">
																		...
																		<?php
																			...
																			{
																		?>
																			You need to be <a class="login-window" href="#login-box" onclick="document.getElementById('username').focus(); $.scrollTo(0, 400, {offset:50}, {easing:'swing'}); load_modal(this); load_modal(this);">logged in</a> to register.
																		<?php
																			}
																		?>
																	</div>
																...
																<span id="desc" style="display:none;">
																	...
																	<p style="text-align:center;">
																		<div class="button button-style1" id="big_register_button" onclick="big_reg_button(); return false;">Register now!</div>
																	</p>
																</span>
