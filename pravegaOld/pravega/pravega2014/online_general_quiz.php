														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<span id="desc" style="display:none;">
																	<img onclick="load_image(this); return false;"  style="cursor: pointer; position: relative; display: inline-block; width: 600px; left:50%; margin-left: -300px;" src="images/events/alphabet_soup_winners.jpg" /><br><br>
																	<?php
