<?php
	...
	$name = "BASF Carbon Carbon Everywhere";
	$db_event_name = $name;
														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width:600px; left:50%; margin-left: -300px; cursor: pointer;" src="images/events/carbon_carbon_everywhere.jpg" onclick="load_image(this);"/><br><br>
																	<?php
