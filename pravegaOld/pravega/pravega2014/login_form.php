...
<html lang="en">
	...
	<head>
		<title>Login | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
														...
														<article class="is is-post">
															...
															<div class=row>
																...
																<?php
																	...
																	{
																?>
																<h2 style="color:red; margin-top:-20px; margin-bottom:20px;">You entered an incorrect username or password.</h2>
																<?php
																	}
																?>
																...
																<form method="post" action="login.php" class="signin">
																	...
																	<tr>
																		...
																		<td><input class="text" autocomplete autofocus type="text" name="email" placeholder="Email Address" value="<?php echo $_SESSION['email']; ?>"></td>
																	</tr>

																	<tr>
																		<td class="form_labels">Password:</td>
																		<td><input class="text" type="password" placeholder="Password" name="password" id="password"></td>
																	</tr>
