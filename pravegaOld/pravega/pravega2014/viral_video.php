														...
														<article class="is is-post">
															...
															<div class="row">
																<span id="register_content" style="display:none;">
																	<div align="center">
																		...
																		<form method="post" action="register_event.php" class="signin">
																			<input type="hidden" name="event_name" value="Viral Video Contest">
																			...
																			<tr>
																				<td class="form_labels">Email Address:<div style="font-size:13px; margin-top:-7px;">(As registered here)</div></td>
																				<td><input autocomplete class="text <?php if (isset($_SESSION['errors_email3']) || isset($_SESSION['errors_activation3']) || isset($_SESSION['errors_in_team3']))echo "error";?>" type="email" name="email3" placeholder="Email Address<?php if ($_SESSION['errors_email3'] == 1) echo " not found, or duplicate."; else if ($_SESSION['errors_activation3'] == 1) echo " not activated."; else if (isset($_SESSION['errors_in_team3'])) echo " already registered."; ?>" <?php if ((!isset($_SESSION['errors_email3'])) && (!isset($_SESSION['errors_activation3'])) && (!isset($_SESSION['errors_in_team3']))) echo 'value="'. $_SESSION['email3']. '"';?>></td>
																			</tr>
																			
																			<tr>
																				<td style="padding-top:15px;"><h3>Team Member 4</h3></td>
																			</tr>
																			<tr>
																				<td class="form_labels">Email Address:<div style="font-size:13px; margin-top:-7px;">(As registered here)</div></td>
																				<td><input autocomplete class="text <?php if (isset($_SESSION['errors_email4']) || isset($_SESSION['errors_activation4']) || isset($_SESSION['errors_in_team4']))echo "error";?>" type="email" name="email4" placeholder="Email Address<?php if ($_SESSION['errors_email4'] == 1) echo " not found, or duplicate."; else if ($_SESSION['errors_activation4'] == 1) echo " not activated."; else if (isset($_SESSION['errors_in_team4'])) echo " already registered."; ?>" <?php if ((!isset($_SESSION['errors_email4'])) && (!isset($_SESSION['errors_activation4'])) && (!isset($_SESSION['errors_in_team4']))) echo 'value="'. $_SESSION['email4']. '"';?>></td>
																			</tr>
																			
																			<tr>
																				<td style="padding-top:15px;"><h3>Team Member 5</h3></td>
																			</tr>
																			<tr>
																				<td class="form_labels">Email Address:<div style="font-size:13px; margin-top:-7px;">(As registered here)</div></td>
																				<td><input autocomplete class="text <?php if (isset($_SESSION['errors_email5']) || isset($_SESSION['errors_activation5']) || isset($_SESSION['errors_in_team5']))echo "error";?>" type="email" name="email5" placeholder="Email Address<?php if ($_SESSION['errors_email5'] == 1) echo " not found, or duplicate."; else if ($_SESSION['errors_activation5'] == 1) echo " not activated."; else if (isset($_SESSION['errors_in_team5'])) echo " already registered."; ?>" <?php if ((!isset($_SESSION['errors_email5'])) && (!isset($_SESSION['errors_activation5'])) && (!isset($_SESSION['errors_in_team5']))) echo 'value="'. $_SESSION['email5']. '"';?>></td>
																			</tr>
																...
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width: 500px; left:50%; margin-left: -250px;" src="images/events/viral_video.jpg" /><br><br>
																	<?php
