<html lang="en">
	<head>
		<title>Buy More Agam Bands | Pravega &ndash; the IISc Science, Tech and Cultural Fest</title>
														...
														<article class="is is-post">
															...
															<div class="2u">
																<div id="sidebar">
																	...
																	<b><a href="extra_ticket">Extra Bands</a></b>
																</div>
															</div>
																...
																<?php
																	if (isset($_POST['email']))
																	{
																		...
																		$query = 'UPDATE usernames SET num_bands = num_bands + '.$num_bands.' WHERE email="'.$email.'"';
																		$result = mysqli_query($link, $query);
																		
																	?>
																	<h2>Successfully added the record.</h2>
																	<?php
																	}
																	...
																	<form action="extra_ticket" method="post">
																		...
																		<tr style="background: transparent;">
																			<td style="text-align:center; padding-top:35px;" colspan="2">
																				...
																				<input class="button_modal textbox" style="display:inline-block; border:0px; border-radius: 3px;" type="submit" value="Update Records">
																				</fieldset>
																			</td>
																		</tr>
																		</table>
