												...
												<!-- Sidebar -->
													<div id="sidebar">
														<section class="is">
															...
															<p><a href="update_form.php">Update Profile</a></p>
															<p><a href="your_events.php">Your Events</a></p>
														</section>
													</div>
												<!-- /Sidebar -->
													...
													<div id="content" style="text-align:center;">
														<article class="is is-post">
															<header class="style1">
																...
																<?php
																	if ($logged == 1)
																		echo $name .' &ndash; Update Profile';
																	else echo 'Update Profile';
																?>
																</h2>
															</header>
															<?php if ($logged == 1)
															...
															<div style="text-align:center">
																...
																<form method="post" action="update.php" class="signin" style="text-align:center;">
																	...
																	<tr>
																		...
																		<td>
																			<input style="width:25px; vertical-align: baseline;" class="text <?php if(isset($_SESSION['errors_gender'])) echo "error";?>" type='radio' name="gender" value="Male" <?php if((isset($_SESSION['gender']) && $_SESSION['gender'] == 'Male') || $gender == 'Male') echo 'checked';?>>Male<span style="padding-left:25px;"></span>
																			<input style="width:25px; vertical-align: baseline;" class="text <?php if(isset($_SESSION['errors_gender'])) echo "error";?>" type='radio' name="gender" value="Female" <?php if((isset($_SESSION['gender']) && $_SESSION['gender'] == 'Female')||$gender == 'Female') echo 'checked';?>>Female
																		</td>
																	</tr>
																	
																	<tr>
																		<td class="form_labels">College:</td>
																		<td><input required class="text <?php if(isset($_SESSION['errors_college'])) echo "error";?>" type="text" maxlength="40" name="college" placeholder="College" <?php if(isset($_SESSION['college'])) echo 'value="'. $_SESSION['college']. '"'; else echo 'value="'.$college.'"'; ?>></td>
																	</tr>
																	
																	<tr>
																		<td class="form_labels">City:</td>
																		<td>
																			<select required id="city" name="city" value="" class="error">
																	...
																	<tr>
																		<td class="form_labels">Need accommodation?<div style="font-size:10pt; margin-top:-5px;">(Not assured)</div></td>
																		<td><input class="text" name="accommodation" type="checkbox" style="width:auto; margin-left:40%;" <?php if ($accommodation == 1) echo "checked";?>></td>
																	</tr>
																	<tr>
															...
															{
															?>
																<h2 style="text-align:center;">You are not logged in. Please login by clicking <a class="link" href="login_form.php">here</a>.</h2>
															<?php
															}
															?>
														</article>
