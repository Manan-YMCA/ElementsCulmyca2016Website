																...
																<span id="register_content" style="display:none;">
																	<div align="center">
																		...
																		<?php
																			...
																			else echo "<b>Event registrations are now closed. Onspot registrations will be allowed.</b>";
																		?>
																	</div>
																</span>
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width:auto; left:50%; margin-left: -300px;" src="images/events/colours_from_the_grey.jpg" /><br><br>
																	<?php
