													...
													<div id="content">
														<article class="is is-post">
															...
															<?php
																...
																else if (isset($_SESSION['error_capacity']))
																{
															?>
																	<hr style="margin:1.5em 0em 1.5em 0em;">
																		<div style="text-align:center;"><h2>Sorry, this event is no longer accepting registrations. However, we may open spot registrations during Pravega.</h2></div>
																	<hr style="margin:1.5em 0em 1.5em 0em;"><br>
															<?php
																}
															?>
															...
															<div class="row">
																...
																<span id="desc" style="display:none;">
																	<img style="position: relative; display: inline-block; width:auto; left:50%; margin-left: -250px;" src="images/events/publish_or_perish.jpg" /><br><br>
																	<?php
