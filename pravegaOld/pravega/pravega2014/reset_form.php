			...
			<a href="#" class="close"><img src="images/close_pop.png" class="btn_close" title="Close Window" alt="Close" /></a>
			  <div class="left_half">
				  <form method="post" class="signin" action="login.php">
						...
						<input id="username" name="email" value="" type="text" autocomplete="on" autofocus placeholder="Email Address">
						</label>
													...
													<div id="content">
														<article class="is is-post">
															...
															<div class=row>
																...
																<?php 
																	if ($_SESSION['errors'] == 1 && $_SESSION['errors_expired'] == 1)
																		echo "<h2>Your reset code has expired. Please get a new code <a href='forgot_pass.php'>here</a>.</h2><br>";
																	else
																	{
																		if ($_SESSION['errors'] == 1 && $_SESSION['errors_expired'] != 1) 
																			echo "<h2>There were some errors in your submission, which are marked in red.<br>Please correct them and submit again.</h2><br>";

																?>
																
																
																		<form method="post" action="reset_pass.php" class="signin">
																			<table style="border-collapse:collapse;">
																			<tr>
																				<td class="form_labels">Email Address:</td>
																				<td>
																					<?php
																						if (isset($_SESSION['errors_email_exists']))
																								echo '<input class="text error" type="email" name="email" required placeholder="Email Address not found, or duplicate.">';
																						else if ($_GET['email'] == "")
																							echo '<input class="text" type="email" name="email" required placeholder="Email Address">';
																						else
																						{
																							echo $_GET['email'];
																					?>
																							<input class="text" type="hidden" name="email" value="<?php echo $_GET['email'];?>">
																					<?php
																						}
																					?>
																				</td>
																			...
																			?>
																					<tr>
																						...
																						<td><input class="text <?php if(isset($_SESSION['errors_code'])) echo "error"; ?>" type="text" name="code" placeholder="Code"></td>
																					</tr>
																			<?php
																				}
																				else
																			...
																			?>
																					<tr>
																						<td colspan="2" style="padding:0px;"><input class="text" type="hidden" name="code" value="<?php echo $_GET['code']; ?>"></td>
																					</tr>
																			<?php
																				}
																			?>
																				<tr>
																					<td class="form_labels">New Password:</td>
																					<td><input class="text <?php if(isset($_SESSION['errors_pass'])) echo "error"; ?>" autocomplete autofocus type="password" required pattern='\S{8,72}' name="password" placeholder="Password (min. length 8)"></td>
																				</tr>

																				<tr>
																					<td class="form_labels">Verify Password:</td>
																					<td><input class="text <?php if(isset($_SESSION['errors_verification'])) echo "error"; ?>" type="password" required pattern='\S{8,72}' placeholder="Verify Password" name="verify_password" id="password"></td>
																				</tr>

																				<tr>
																					<td style="text-align:center; padding-top:35px;" colspan="2">
																						<fieldset class="textbox">
																						<input class="button_modal textbox" style="display:inline-block; border:0px;" type="submit" value="Login">
																						</fieldset>
																					</td>
																				</tr>
																				</table>
