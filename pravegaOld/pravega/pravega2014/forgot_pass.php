													...
													<div id="content">
														<article class="is is-post">
															...
															<div class=row>
																...
																<form method="post" action="send_reset.php" class="signin">
																	<table style="border-collapse:collapse;">
																	<tr>
																		<td colspan="2">
																			<?php
																				if (isset($_SESSION['invalid']))
																					echo "The email you entered was not found. Please try again.<br>";
																				else
																				{
																					echo "Enter your email address and we will send you your password reset information.<br>";
																				}
																			?>
																			<br>
																		</td>
																	...
																	<tr>
																		...
																		<td><input class="text <?php if(isset($_SESSION['invalid'])) echo "error";?>" autocomplete autofocus type="text" name="email" placeholder="Email Address" <?php if (isset($_SESSION['invalid'])){ ?> value="<?php echo $_SESSION['email'];?>"<?php } ?>></td>
																	</tr>

																	<tr>
																		<td style="text-align:center; padding-top:35px;" colspan="2">
																			<fieldset class="textbox">
																			<input class="button_modal textbox" style="display:inline-block; border:0px;" type="submit" value="Submit">
																			</fieldset>
																		</td>
																	</tr>
																	</table>
