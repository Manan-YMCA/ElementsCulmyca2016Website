													...
													<div id="content">
														<article class="is is-post">
															...
															<div class=row>
																...
																You have successfully registered with the email address <?php echo $_SESSION['email']; ?>.<br> Please check your email and follow the instructions to activate your account. Sometimes the activation email may be misclassified as spam, so please check your spam folder as well.
																</div>
