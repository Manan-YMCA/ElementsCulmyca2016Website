														...
														<article class="is is-post">
															...
															<div class="row">
																...
																<?php
																	...
																	if ($_SESSION['errors'] == 1) echo "<h2>There were some errors in your submission, which are marked in red.<br>Please correct them and submit again.</h2><br>";
																?>
																<form method="post" action="register_new.php" class="signin">
																	...
																	<tr>
																		...
																		<td><input required class="text <?php if(isset($_SESSION['errors_emergency_contact'])) echo "error";?>" type='tel' pattern='\d{10}' maxlength="10" name="emergency_contact" placeholder="Emergency Number (10 digit)" <?php if(isset($_SESSION['emergency_contact'])) echo 'value="'. $_SESSION['emergency_contact']. '"';?>></td>
																		</td>
																	</tr>
