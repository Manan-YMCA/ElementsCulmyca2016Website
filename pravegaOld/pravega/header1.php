                          ...
                          <nav class="vertical">
                            <ul>
                              ...
                              <li class="button" style="padding:0; text-align:left;">
                                ...
                                <div>
                                  <ul>
									<li><a href="microsoft.php">Microsoft Machine Learning Challenge!</a></li>
							  ...
							  <li class="button" style="padding:0; text-align:left;">
                                <label for="Inhouse Workshops">Workshops</label>
                                <input type="checkbox" class="menu_check" name="verticalMenu" id="Inhouse Workshops" />
                                <div>
                                  <ul>
                                    <li><a href="w_gamedev.php">Game Development</a></li>
                                    <li><a href="w_automobile.php">Automobile Mechanics & IC Engines</a></li>
                                    <li><a href="w_hci.php">Human Robot Interaction</a></li>
									<li><a href="w_ehacking.php">Ethical Hacking</a></li>
									<li><a href="w_blueprint.php">Automobile Blueprint</a></li>
									<li><a href="w_winguav.php">Fixed Wing UAV</a></li>
									<li><a href="w_cansat.php">CanSat</a></li>
									<li><a href="w_robotics.php">Mobile Controlled Robotics</a></li>
									<li><a href="workshops.php">Outreach Workshops</a></li>
                                  </ul>
                                </div>
                              </li>
                              <li class="button" style="padding:0; text-align:left;">
