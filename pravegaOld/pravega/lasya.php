...
?> 
	...
	<p style="text-align:center"><h2><br>Lasya</h2></p>
                        <img src="img/lasya_bg.png" height="430px"></img><br>
...
• Teams registered must submit their tracks (finals - 10 minutes) at least one and half hour before the event in a pen drive and CD in MP3 format and are requested to keep back up.<br>
• The following particulars are to be written on the CD: Name of the Team Leader, his Pravega username and phone number.<br>
• The last date for registration is 25<sup>th</sup>&nbspJanuary, 2015.<br>
• Team leaders must pick out spots at the specified time to decide the order of on-stage appearances.<br>
• Team members need not necessarily be from the same college.<br>
• Any number of teams is permitted from a college. But no participant can be a member of more than one team.<br>
• In addition to the maximum permissible number of dancers, each team can have a maximum of 3 non-dancers for music, lights, narration.<br>
...
• No additional time will be given for setting up the stage or props. Props include objects carried by participants, such as sticks, swords, pots etc.<br> 
...
• Choreography and coordination<br>
• Costumes, Song Selection and Properties<br>
• Stage presence and style<br>
